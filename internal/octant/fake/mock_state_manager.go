...
// Source: github.com/vmware-tanzu/octant/internal/octant (interfaces: StateManager)
...
func (m *MockStateManager) Start(arg0 context.Context, arg1 octant.State, arg2 octant.StateClient) {
	m.ctrl.T.Helper()
